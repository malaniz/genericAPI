...
var nodemailer = require('nodemailer'), md5 = require('MD5'), smtpTransport = null, urlConfirmMail = null, mailOptions = {};
...
exports.sendConfirmateMail = function (to) {
    var subject = 'Por favor, confirma tu email. Eatnow!', token = md5(Date() + to), html = getLinkConfirmate(to, token);
